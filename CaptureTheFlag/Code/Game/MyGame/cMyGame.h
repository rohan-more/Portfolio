...
namespace eae6320
{
	...
	private:
		...
		const char* GetPathToLogTo() const override { return "eae6320_u1014659.log"; }
#if defined( EAE6320_PLATFORM_WINDOWS )
		...
		{
			return "Rohan More's EAE6320 Game"
				" -- "
		...
		const char* GetMainWindowClassName() const override { return "Rohan More's EAE6320 Main Window Class"; }
