...
<form action='/intraarms/AccountEditServlet' method="get">
...
<table width="100%"  border="0">
  <tr>
    ...
    <td width="20%"><jsp:getProperty name='account' property='login' /></td>
    <td width="33%">&nbsp;</td>
    <td width="13%"><%=account.flagType()%>Type:</td>
    <td width="20%"><jsp:getProperty name='account' property='type' /></td>
  </tr>
  <tr>
